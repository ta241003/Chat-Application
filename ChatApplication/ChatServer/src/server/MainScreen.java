...
public class MainScreen extends JFrame implements ActionListener {
	...
	public MainScreen() {
		setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\ChatApplication\\ChatClient\\src\\img\\server-app.png"));
		...
		openCloseButton.setBackground(SystemColor.inactiveCaption);
