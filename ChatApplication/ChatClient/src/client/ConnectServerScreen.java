...
public class ConnectServerScreen extends JFrame implements ActionListener {
	...
	public ConnectServerScreen() {
		...
		serverList = FileManager.getServerList();
		  ...
		  // từ data đã đọc đổ lên sql
		FileManager.toSql(serverList);
		///
		
		
		
		setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\ChatApplication\\ChatClient\\src\\img\\app-chat.png"));
		GBCBuilder gbc = new GBCBuilder(1, 1);
		JPanel connectServerContent = new JPanel(new GridBagLayout());

		JButton refreshButton = new JButton("Làm mới");
		refreshButton.setIcon(new ImageIcon("D:\\ChatApplication\\ChatClient\\src\\img\\loading-icon.png"));
		refreshButton.setBackground(SystemColor.info);
		...
		joinButton.setIcon(new ImageIcon("D:\\ChatApplication\\ChatClient\\src\\img\\join-icon.png"));
		joinButton.setBackground(SystemColor.info);
		...
		addButton.setIcon(new ImageIcon("D:\\ChatApplication\\ChatClient\\src\\img\\add-icon.png"));
		addButton.setBackground(Color.PINK);
		addButton.addActionListener(this);
		addButton.setActionCommand("add");

		JButton deleteButton = new JButton("Xoá");
		deleteButton.setIcon(new ImageIcon("D:\\ChatApplication\\ChatClient\\src\\img\\delete-icon.png"));
		deleteButton.setBackground(Color.PINK);
		deleteButton.addActionListener(this);
		deleteButton.setActionCommand("delete");

		JButton editButton = new JButton("Sửa");
		editButton.setIcon(new ImageIcon("D:\\ChatApplication\\ChatClient\\src\\img\\edit-icon.png"));
